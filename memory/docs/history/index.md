...
### 追加
- 週次活動報告: `memory/docs/2026/03/21/topic-weekly-activity-report-2026-03-14-to-2026-03-21.md`
- 日次ページ: `memory/docs/2026/03/21/index.md`
- 可視化 asset: `memory/docs/2026/03/21/assets/weekly-activity-2026-03-14-to-2026-03-21.svg`
- 可視化 asset: `memory/docs/2026/03/21/assets/weekly-activity-2026-03-14-to-2026-03-21.png`

### 更新
- `memory/docs/2026/03/index.md` に `2026-03-21` の週次活動報告リンクを追加
- `memory/docs/history/index.md` に本エントリを追加

### 内容
- `2026-03-14` から `2026-03-21` の活動を、daily records / history / company repo / child repo git logs から再構成
- `company repo commits` と `gameplay repo commits` を同じカードに載せた `Activity Pulse` グラフを追加
- 既存 showcase asset を使って `onigame-dodge60` / `onigame-lane-flip-sprint` / `onigame-one-stroke-sweep` / `onigame-omikuji` の screenshots を週報 topic に埋め込み
- `Pocket Putt Panic` は `selected and scoped, but not launched` として記録し、repo missing / no first commit / no Pages verify を明示
